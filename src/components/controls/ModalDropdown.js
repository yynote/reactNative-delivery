...
export default class ModalDropdown extends Component {
  ...
  _calcPosition() {
    ...
    const dropdownHeight = Math.min(250, options.length * 50 + 1);
    ...
    const positionStyle = {
      ...
      top: showInBottom ? this._buttonFrame.y + (this._buttonFrame.h / 3) + 0 : Math.max(0, this._buttonFrame.y - dropdownHeight - 6),
    };
