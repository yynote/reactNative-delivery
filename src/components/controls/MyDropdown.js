    ...
    return (
      <View style={[{ justifyContent: "center" }, this.props.style]}>
        ...
        <TouchableWithoutFeedback onPress={() => {
          ...
          <ResizedImage
            source={require("src/assets/images/ic_arrow_dropdown.png")}
  ...
  _dropdown_renderButtonText(rowData) {
    return (
      <Text style={{ width: "100%", alignItems: "center", flexDirection: "row", justifyContent: "center" }}>
        <Text style={TextStyles.TEXT_STYLE_16}>{rowData.value} </Text>
        <ResizedImage source={require("src/assets/images/ic_arrow_dropdown.png")} style={{ alignSelf: "center" }} />
      </Text>
    );
  }
